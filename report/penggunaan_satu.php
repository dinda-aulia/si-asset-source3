...
<html>
    <head>
        <title>Cetak Data Penggunaan Asset Kantor</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PENGGUNA ASSET KANTOR</h3>
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td>Nama Pengguna</td> <td><?= $data['nm_pengguna'] ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Digunakan</td> <td><?= $data['tgl_digunakan'] ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Kembali</td> <td><?= $data['tgl_kembali'] ?></td>
                                </tr>
								<tr>
                                    <td>Lama Digunakan</td> <td><?= $data['lama_guna'] ?> hari</td>
                                </tr>
