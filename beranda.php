    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Sistem Informasi Data Aset Kantor</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Aset Kantor</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th >No.</th><th width="30%">Nama Barang</th><th>Tanggal Beli</th><th>Merek</th><th>Jumlah</th><th>Satuan</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
